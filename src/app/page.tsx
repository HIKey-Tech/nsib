        ...
        <div className={`container ${styles.ctaContainer}`}>
          <ScrollReveal direction="up" delay={0.1} distance={40} className={styles.ctaContent}>
            ...
            <p style={{ fontWeight: 700, letterSpacing: "0.02em" }}>
              24/7 Emergency Lines: <a href="tel:+2348077090908" className={styles.textLinkWhite}>+234 807 709 0908</a> / <a href="tel:+2348077090909" className={styles.textLinkWhite}>+234 807 709 0909</a>
            </p>
